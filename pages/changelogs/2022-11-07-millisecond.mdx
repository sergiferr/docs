...
>Note: If you are sending data into Mixpanel via a CDP or Data Warehouse, no change is required at your end if you’re already tracking data at ms precision.
